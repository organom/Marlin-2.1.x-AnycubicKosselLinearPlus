...
#define STRING_CONFIG_H_AUTHOR "2.1.1 by organom" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Kossel Linear Plus by organom"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 160 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 */
  ...
  #define NOZZLE_TO_PROBE_OFFSET { 0, -10.0, -13.33 }
